...
class StudentNotification extends Model
{
    ...
    protected $fillable = [
        'tenant_id', 'user_id', 'type', 'title', 'body', 'icon', 'url', 'is_read', 'read_at',
    ];
    ...
    {
        return match($this->icon) {
            'video'   => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.07A1 1 0 0121 8.845v6.31a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z"/>',
            ...
            'live'    => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5.636 18.364a9 9 0 010-12.728m12.728 0a9 9 0 010 12.728M12 12h.01M9.172 16.172a4 4 0 015.656 0M6.343 9.343a8 8 0 0111.314 0"/>',
