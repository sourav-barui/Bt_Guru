    ...
    <aside class="fixed top-0 left-0 z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0 bg-white border-r border-gray-200">
        ...
        <div class="h-16 flex items-center px-6 border-b border-gray-200">
            <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2">
                ...
                <span class="text-lg font-semibold text-gray-900">Guru Admin</span>
            </a>
        </div>
        ...
        <nav class="p-4 space-y-1">
            ...
            <a href="{{ route('admin.subscription_plans.index') }}" class="sidebar-link {{ request()->routeIs('admin.subscription_plans*') ? 'active' : '' }}">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <header class="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6 sticky top-0 z-30">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="w-8 h-8 bg-blue-100 rounded-full flex items-center justify-center">
                    <span class="text-blue-600 font-medium text-sm">SA</span>
                </div>
            </div>
        </header>
