...
<div class="space-y-6">
    ...
    <!-- Exam Form -->
    <form action="{{ route('tenant.exams.store', $course) }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 mt-1">More templates coming soon</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="mt-4 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <label class="flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="show_result_immediately" value="1" {{ old('show_result_immediately', true) ? 'checked' : '' }}
                           class="rounded border-gray-300 text-purple-600 focus:ring-purple-500">
