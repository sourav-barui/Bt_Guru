...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('tenant.curriculum.chapters.store', [$course, $subject]) }}">
            @csrf

            <div class="mb-4 p-3 bg-blue-50 rounded-lg">
                <p class="text-sm text-blue-700">
                    <span class="font-medium">Subject:</span> {{ $subject->title }}
                </p>
            </div>
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3" 
                              class="form-input" placeholder="Brief description of this chapter">{{ old('description') }}</textarea>
                </div>
