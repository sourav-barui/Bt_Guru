...
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('tenant.curriculum.subjects.update', [$course, $subject]) }}">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input type="text" id="title" name="title" value="{{ old('title', $subject->title) }}" 
                ...
                <div>
                    ...
                    <textarea id="description" name="description" rows="3" 
                              class="form-input" placeholder="Brief description of this subject">{{ old('description', $subject->description) }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select id="status" name="status" class="form-input">
                            ...
                            <option value="draft" {{ old('status', $subject->status) == 'draft' ? 'selected' : '' }}>Draft</option>
