                            ...
                            <div class="p-4">
                                <div class="flex items-center justify-between mb-3">
                                    ...
                                    <div class="flex items-center gap-1">
                                        ...
                                        <button onclick="toggleContentForm('subject-video-{{ $subject->id }}')"},{"old_string":"                                                <div class="flex items-center gap-1">
                                                    ...
                                                    <button onclick="toggleContentForm('video-{{ $chapter->id }}')" class="p-1.5 text-blue-400 hover:text-blue-600 hover:bg-blue-50 rounded" title="Add Video">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
