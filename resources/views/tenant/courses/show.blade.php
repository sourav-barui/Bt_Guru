                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex items-center gap-3">
                                    ...
                                    <form method="POST" action="{{ route('tenant.enrollments.destroy', $enrollment) }}"
                                          onsubmit="return confirm('Are you sure you want to unenroll {{ addslashes($enrollment->student->name) }}?');"
                                          class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" title="Unenroll"
                                                class="text-red-500 hover:text-red-700 transition inline-flex items-center justify-center w-8 h-8 rounded-lg hover:bg-red-50">
