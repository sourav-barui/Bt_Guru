...
<div class="space-y-6">
    ...
    <div class="flex items-center justify-between">
        <div>
            <a href="{{ route('btlive.teacher_room', $liveClass) }}" class="text-sm text-gray-500 hover:text-gray-700 flex items-center gap-1 mb-1">
            ...
            <p class="text-gray-500">{{ $liveClass->course->title }}</p>
        </div>
